# Plan: Flavor Forge Foundry VTT Module + Generator Improvements
...
**Status:** complete
- [x] Create `foundry-module/flavor-forge/` directory structure
...
- [x] `styles/flavor-forge.css` — basic styling
...
**Status:** complete
- [x] `src/flavor_forge/exporters/flavor_forge_module.py` — new combined JSON exporter
...
- [x] Update `__main__.py` — add `--export flavor-forge` option
- [x] Update `__init__.py` — export new function
- [x] Test end-to-end: generate creature → export flavor-forge JSON → validate format
